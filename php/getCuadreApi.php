<?php
			...
			$sql.='concat_ws(" ",tipo_pago,detalle,items) as Descripcion,sum(valor_abono) as Valor';
			$sql.=' from abonos';
			...
			$sql.=' concat_ws(" ","@ANULADA",tipo_pago,detalle,items,"@ANULADA"),sum(valor_abono)';
