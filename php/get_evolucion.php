<?php
			...
			$sql.="evolucion.procedimiento as codproc,evolucion.proxima_cita as codproxima,evolucion.tipo,citas.hora_salida";
			$sql.=" from evolucion";
			$sql.=" inner join procedimientos on evolucion.procedimiento=procedimientos.codigo";
			$sql.=" left join procedimientos as procedimientos2 on evolucion.proxima_cita=procedimientos2.codigo";
